...
#define AEESTD_H
/*====================================================================
   Copyright 2004-2007, 2016 QUALCOMM Technologies, Incorporated.
               All Rights Reserved.
...
extern int           std_memcpy_s(void* pDest, int nDestBufferLength, const void* pSource, int nLength);
extern void *        std_memmove(void *pTo, const void *cpFrom, int nLen);
extern int           std_memmove_s(void* pDest, int nDestBufferLength, const void* pSource, int nLength);
