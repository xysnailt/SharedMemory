...
///
/// @param ctxt             Pointer to display context
/// @param user_ctxt        Pointer to window
...
/// @return QCARCAM_RET_OK if successful
///////////////////////////////////////////////////////////////////////////////
qcarcam_ret_t test_util_post_window_buffer(test_util_ctxt_t *ctxt, test_util_window_t *user_ctxt, unsigned int idx, std::list<uint32>* p_rel_buf_idx, qcarcam_field_t field_type);
